...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.last_photo'
        db.delete_column('people_profile', 'last_photo')

        # Adding field 'Profile.photo'
        db.add_column('people_profile', 'photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['message.Message'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Profile.last_photo'
        db.add_column('people_profile', 'last_photo',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Profile.photo'
        db.delete_column('people_profile', 'photo_id')
    ...
    models = {
        ...
        'message.message': {
            ...
            'photo': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'txt': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            'typ': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
        ...
        'people.profile': {
            ...
            'cover_photo': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['message.Message']", 'null': 'True', 'blank': 'True'}),
            ...
            'reg_id': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'people.relation': {
            ...
            'is_valid': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'new': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'tag': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
