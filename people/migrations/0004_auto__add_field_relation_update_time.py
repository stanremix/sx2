...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Relation.update_time'
        db.add_column('people_relation', 'update_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Relation.update_time'
        db.delete_column('people_relation', 'update_time')
