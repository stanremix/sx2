...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.reg_id'
        db.add_column('people_profile', 'reg_id',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.reg_id'
        db.delete_column('people_profile', 'reg_id')
    ...
    models = {
        ...
        'people.profile': {
            ...
            'is_valid': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'last_photo': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
