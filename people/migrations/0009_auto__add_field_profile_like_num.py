...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.like_num'
        db.add_column('people_profile', 'like_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.like_num'
        db.delete_column('people_profile', 'like_num')
    ...
    models = {
        ...
        'people.profile': {
            ...
            'is_valid': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'like_num': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
