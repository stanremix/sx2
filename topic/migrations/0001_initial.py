...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('topic_category', (
        ...
        db.send_create_signal('topic', ['Category'])
        ...
        db.create_table('topic_topic', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['topic.Category'], null=True, blank=True)),
            ('bgcolor', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('topic', ['Topic'])

        # Adding model 'UserFollowTopic'
        db.create_table('topic_userfollowtopic', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_valid', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('tag', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('topic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['topic.Topic'])),
            ('update_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('topic', ['UserFollowTopic'])


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table('topic_category')

        # Deleting model 'Topic'
        db.delete_table('topic_topic')

        # Deleting model 'UserFollowTopic'
        db.delete_table('topic_userfollowtopic')
    ...
    models = {
        ...
        'topic.topic': {
            ...
            'bgcolor': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['topic.Category']", 'null': 'True', 'blank': 'True'}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_valid': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'tag': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'topic.userfollowtopic': {
            'Meta': {'object_name': 'UserFollowTopic'},
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_valid': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'tag': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
