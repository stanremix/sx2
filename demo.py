...
APPKEY = "7CvTAbCOAA8LBhLTDPLa69"
APPID = "aCIkEtTVm27RooUy0jv8u3"
MASTERSECRET = "u03VnNvR9E7oqxPstbOaX2"
CID = "755051268313969727"
HOST = 'http://sdk.open.api.igexin.com/apiex.htm'
DEVICETOKEN = "b1984b7f89059febf64d2784da25b9c403e3e44554818858d0db133a33c92dcd"
...
def pushAPN():
    ...
    template.setPushInfo("a", 1, "n", "", "现行的房产税是第二步利改税以后开征的，1986年9月15日，国务院正式发布了《中华人民共和国房产税暂行条例》，从1986年10", "", "", "")
    #单个用户推送接口
...
def TransmissionTemplateDemo():
    ...
    template.appId = APPID
    template.appKey = APPKEY
    template.transmissionContent = 'neirong2'
    #iOS 推送需要的PushInfo字段 前三项必填，后四项可以填空字符串
    #template.setPushInfo(actionLocKey, badge, message, sound, payload, locKey, locArgs, launchImage)
    template.setPushInfo("",2,"neirong1","","{user:5}","","","");
    return template
